    ...
    <>
      ...
      <main>
        ...
        <section className="relative isolate min-h-[88svh] overflow-hidden bg-ice-800 text-white">
          <Image src={HERO.image} alt={HERO.imageAlt} fill priority sizes="100vw" className="object-cover object-[60%_center] md:object-center" quality={80} />
          <div className="absolute inset-0 bg-gradient-to-t from-ice-900/88 via-ice-900/40 to-ice-900/10" aria-hidden="true" />
        ...
        <section className="wrap pt-14 md:pt-20">
          <SectionHead title={SEASON === "winter" ? "Зимние туры на Байкал 2027" : "Летние туры на Байкал"} lead={SEASON === "winter" ? "Лёд встаёт в январе, самый прозрачный — с середины февраля до середины марта. Все заезды стартуют в Иркутске: по льду — только на хивусах, на Ольхон — по официальной ледовой переправе, дальше на УАЗ по острову." : "Навигация с мая по сентябрь: Ольхон, КБЖД, круизы, баня на берегу."} />
